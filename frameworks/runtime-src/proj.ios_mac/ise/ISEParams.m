...
NSString* const KCTimeoutDefault=@"5";
...
- (void)setDefaultParams{
    ...
    self.language=KCLanguageENUS;
    self.languageShow=KCLanguageShowENUS;
    self.category=KCCategoryWord;
    self.categoryShow=KCCategoryShowWord;
