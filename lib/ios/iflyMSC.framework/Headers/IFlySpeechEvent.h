 ...
 *  事件类型
 */
typedef NS_ENUM(NSUInteger,IFlySpeechEventEnum){
    /*!
     *  网络状态消息
     */
    ...
    /*!
     *  TTS合成数据消息 * -(void)onEvent:(int)eventType arg0:(int)arg0 arg1:(int)arg1 data:(NSData *)eventData * 其中eventData中包含数据 *
     */
 ...
 *
 *  @return IVW oneshot 听写 or 识别结果 key
 */
